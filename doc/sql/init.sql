...
CREATE DATABASE IF NOT EXISTS tomato_account_00 DEFAULT CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_general_ci;
CREATE DATABASE IF NOT EXISTS tomato_account_01 DEFAULT CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_general_ci;

-- 订单
CREATE DATABASE IF NOT EXISTS tomato_order DEFAULT CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_general_ci;
CREATE DATABASE IF NOT EXISTS tomato_order_00 DEFAULT CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_general_ci;
CREATE DATABASE IF NOT EXISTS tomato_order_01 DEFAULT CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_general_ci;
-- 商户
CREATE DATABASE IF NOT EXISTS tomato_merchant DEFAULT CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_general_ci;
-- 通知
CREATE DATABASE IF NOT EXISTS tomato_notify DEFAULT CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_general_ci;
-- 打款
CREATE DATABASE IF NOT EXISTS tomato_remit DEFAULT CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_general_ci;
-- 分布式任务调度中心
CREATE DATABASE IF NOT EXISTS tomato_job DEFAULT CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_general_ci;
-- 代码生成
CREATE DATABASE IF NOT EXISTS tomato_codegen DEFAULT CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_general_ci;