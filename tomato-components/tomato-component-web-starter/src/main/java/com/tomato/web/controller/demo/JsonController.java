...
public class JsonController {
    ...
    public Response demo1(@RequestBody Demo demo) {
    ...
    public Response  demo2(@RequestParam(value = "demo", required = false) String demo) {
        return SingleResponse.of(demo);
    }
    /**
    ...
    public Response  demo3(@RequestBody Demo demo) {
        return SingleResponse.of(demo);
    }
}
